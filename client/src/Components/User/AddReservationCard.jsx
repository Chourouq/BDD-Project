    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/api/v1/reservation', {
                ...
                // replace with actual spot ID
                resdate: selectedDate,
                restime: selectedHour,
                price: price,
            ...
            // Add any logic here to handle success, close the modal, or update UI as needed


            
             

            await axios.post('http://localhost:3000/api/v1/notification', {
            ...
            // Add any logic here to handle errors, show a message, or update UI as needed
        }
    };
